...
- El proyecto consiste en una aplicación web innovadora y moderna construida como una Single Page Application (SPA), enfocada en la comunidad de fanáticos de películas y series. La aplicación adopta un diseño adaptable para dispositivos móviles, desarrollado siguiendo la metodología 'Mobile First' y haciendo uso de CSS Grid para lograr una experiencia de usuario fluida en diferentes tamaños de pantalla.
